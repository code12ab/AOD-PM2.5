...
if save_year % 4 == 0:
    year_days = 366-int(dayinyear_start)-136 # 365为年度; 139适用于"5.19"; 334+31适用于13年
else:
    year_days = 365-int(dayinyear_start)-136

start_count = 8888  # 刘家园超出次数，没完成
...
for jcz in JCZ:
    ...
    while count_error != 0:  # 多次报错则放弃爬取;这里重新爬取一次

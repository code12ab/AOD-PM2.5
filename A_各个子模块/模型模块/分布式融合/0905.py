...
# AOD + AODs
aods_x1 = Dense(16,
                activation=keras.layers.ELU(alpha=0.25),
                name="FC1_aods")(aods_concat)

# AOD + 气象
meteorology_x1 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FC1_meteorology")(meteorology_concat)
...
meteorology_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionMA")(meteorology_x1)

meteorology_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionMA_RC")(meteorology_residual_connection1)
...
weather_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionWA")(weather_x1)

weather_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionWAForRC")(weather_residual_connection1)
...
ndvi_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionNDVI")(ndvi_x1)

ndvi_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionNDVI_RC")(ndvi_residual_connection1)
...
time_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionTime")(time_x1)

time_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionTime_RC")(time_residual_connection1)
...
station_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionStation")(station_x1)

station_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionStation_RC")(station_residual_connection1)
...
allin_residual_connection1 = Dense(
    8, activation=keras.layers.ELU(alpha=0.25), name="ResidualConnectionAIA")(allin_x1)

allin_residual_connection2 = Dense(
    16, activation=keras.layers.ELU(alpha=0.25), name="FullConnectionAIA_RC")(allin_residual_connection1)
...
# AOD + 时滞
weather_y = core.Dropout(rate=0.01,
                         name="Weather_Module")(weather_x2)


# AOD + NDVI
ndvi_y = core.Dropout(rate=0.01,
                      name="NDVI_Module")(ndvi_x2)


# AOD + 时间
time_y = core.Dropout(rate=0.01,
                      name="Time_Module")(time_x2)

# AOD + 空间
station_y = core.Dropout(rate=0.01,
                         name="Station_Module")(station_x2)


# 全部特征
allin_y = core.Dropout(rate=0.01,
...
aods_y2 = Dense(4,
                activation=keras.layers.ELU(alpha=0.25),
                name="FullConnectionAODs_3")(aods_y)


# AOD + 气象
meteorology_y2 = Dense(4,
                       activation=keras.layers.LeakyReLU(alpha=0.1),
                       name="FullConnectionMA_3")(meteorology_y)


# AOD + 时滞
weather_y2 = Dense(4,
                   activation=keras.layers.ELU(alpha=0.25),
                   name="FullConnectionWA_3")(weather_y)


# AOD + NDVI
ndvi_y2 = Dense(4,
                activation=keras.layers.ELU(alpha=0.25),
                name="FullConnectionNDVI_3")(ndvi_y)


# AOD + 时间
time_y2 = Dense(4,
                activation=keras.layers.ELU(alpha=0.25),
                name="FullConnectionTime_3")(time_y)


# AOD + 空间
station_y2 = Dense(4,
                   activation=keras.layers.ELU(alpha=0.25),
                   name="FullConnectionStation_3")(station_y)


# 全部特征
allin_y2 = Dense(4,
                 activation=keras.layers.ELU(alpha=0.25),
                 name="FullConnectionAIA_3")(allin_y)

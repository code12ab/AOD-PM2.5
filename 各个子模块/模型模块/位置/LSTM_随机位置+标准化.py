...
for t_numb in range(0, 20):
    ...
    # 生成虚拟训练数据
    x_test = data_test[['id','tm_mon','AOD_0','AOD_1', 'AOD_2', 'AOD_3', 'AOD_4', 'AOD_5', 'AOD_6', 'AOD_7', 'AOD_8', 'AOD_9',
                     'AOD_10', 'AOD_11', 'AOD_12', 'AOD_13', 'AOD_14', 'AOD_15', 'AOD_16']].values.reshape(38,365,19) # pm+id ==2
    x_train = data_train[['id','tm_mon','AOD_0','AOD_1', 'AOD_2', 'AOD_3', 'AOD_4', 'AOD_5', 'AOD_6', 'AOD_7', 'AOD_8', 'AOD_9',
                     'AOD_10', 'AOD_11', 'AOD_12', 'AOD_13', 'AOD_14', 'AOD_15', 'AOD_16']].values.reshape(114,365,19) # pm+id ==2
    ...
    model = Sequential()
    model.add(LSTM(128, return_sequences=True, input_shape=(timesteps, data_dim)))  # 返回维度为 32 的向量序列
    model.add(LSTM(64, return_sequences=True))
    model.add(LSTM(32, return_sequences=True))
    model.add(LSTM(16, return_sequences=True))
    model.add(LSTM(8, return_sequences=True))  # 返回维度为 32 的向量序列
    model.add(core.Dropout(rate=0.01))
    model.add(LSTM(4,))  # 返回维度为 32 的单个向量
    ...
    model.fit(x_train, y_train,
              batch_size=152, epochs=3,verbose=2)

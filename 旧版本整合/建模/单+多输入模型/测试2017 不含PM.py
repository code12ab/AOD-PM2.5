...
# 输入2
y = layers.Dense(8, activation="relu")(inputB)
...
model.fit([x1_train_np, x2_train_np, x3_train_np, x4_train_np], y_train_np, epochs=10000, batch_size=256)

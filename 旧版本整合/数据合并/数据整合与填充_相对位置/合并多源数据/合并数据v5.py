...
#####################################################################合并部分2########################################
    ...
    input_PM = "F:\\毕业论文程序\\污染物浓度\\整理\\日均\\"+location+".xlsx"
    input_temperature_mean = "F:\\毕业论文程序\\气象数据\\整理\\逐时均值\\"+location+".xlsx"
    ...
    data_final.to_excel("F:\\毕业论文程序\\整合数据\\整合1\\%s.xlsx" % location)
   # print(location)
